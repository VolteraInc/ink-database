...
export default new Ink({
  ...
  lot: 'Paste - 540008-3829',
  useBy: '2019-02-01',
  storage: '4°C – 10°C',

  description: `
    Standard T5 solder paste for use with both pre­fabbed and
    V­-One-printed PCBs. The smaller particle size (T5) improves
    dispensing and reduces nozzle clogging.
  `,

  label: {
    type: 'SOLDER PASTE T5',
    color: '#ff770b',
  },
